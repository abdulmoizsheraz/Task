      ...
      <section className="text-center py-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around  ">
          ...
          <div className="md:w-1/2 mt-4 md:mt-0  " style={{"margin-left":"-157px"}}>
            <button className="bg-custom-200 text-right text-white font-semibold rounded-full px-6 py-2 mb-4">Step 1</button>
            <h3 className=" font-semibold text-left text-custom-50 text-5xl font-sans mb-2">Essential Nutrition Report</h3>
